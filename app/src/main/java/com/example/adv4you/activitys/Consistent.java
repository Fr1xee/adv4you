...
public class Consistent extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.reviews_tw:
                newActivity = new Intent(Consistent.this, Reviews.class);
                newActivity.putExtra("type", "Последовательно-постоянный");
                startActivity(newActivity);
                break;
            case R.id.place_an_order:
            case R.id.place_an_order_tw:
                newActivity = new Intent(Consistent.this, MakingAnOrder.class);
                newActivity.putExtra("type", "Последовательно-постоянный");
                startActivity(newActivity);
                break;

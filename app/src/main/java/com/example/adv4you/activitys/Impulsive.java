...
public class Impulsive extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.reviews_tw:
                newActivity = new Intent(Impulsive.this, Reviews.class);
                newActivity.putExtra("type", "Импульсивный");
                startActivity(newActivity);
                break;
            case R.id.place_an_order:
            case R.id.place_an_order_tw:
                newActivity = new Intent(Impulsive.this, MakingAnOrder.class);
                newActivity.putExtra("type", "Импульсивный");
                startActivity(newActivity);
                break;
        }
